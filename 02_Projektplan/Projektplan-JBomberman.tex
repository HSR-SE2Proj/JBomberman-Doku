...
\hline
\textbf{Elaboration 1} & \shortstack{Anforderungen definiert\, Technologien ausgewählt \\ und Projektplan fertig gestellt. \\ Erster Prototyp zum Testen mit Grundfunktionen \\(Befehle an Server senden).} & 05.03.15 \\
\hline
\textbf{Elaboration 2} & \shortstack{Use Cases aufschreiben,\\ dazu das Spielprinzip genauer beschreiben.\\ Nicht Funktionale Anforderungen aufschreiben \\und darauch testen (Performance)} & SW05 \\
\hline
\textbf{Elaboration 3} & \shortstack{Architektur Prototyp \\(Kommunikationsverfahren zwischen \\ Client und Server), erste Performance \\ Tests zum ausgewählten.} & SW06 \\
\hline
\textbf{Construction 1} & \shortstack{Hauptfeatures implementieren \\ (Kollisionsdetektion, Bomben \\ Funktionieren, Powerups funktionieren} & SW09 \\
\hline
\textbf{Construction 2} & \shortstack{Spielablauf und Matchmaking feritg.\\ Falls genügend Zeit werden \\ werden noch erweiterte Features eingebaut.} & SW11 \\
\hline
\textbf{Construction 3} & \shortstack{Suchablauf und Matchmaking feritg.\\ Falls genügend Zeit werden \\ werden noch erweiterte Features eingebaut.} & SW13 \\
\hline
\textbf{Transition} & \shortstack{Vorbereitung zur Schlusspräsentation \\ und Abgabe.} & SW15 \\
\hline
...
\hline
\textbf{05.03.15} & \shortstack{Review Projektplan \\ mit Zeitplan und aktuellen \\ Iterationsplänen} & MS1-RV Projektplan \\
\hline
\textbf{SW05} & \shortstack{Review der Anforderungsspezifikation  \\ und der Domainanalyse} & \shortstack{MS2-RV \\ Anforderungen und Analyse} \\
\hline
\textbf{SW07} & \shortstack{Zwischenpräsentation mit Demo \\ einesArchitekturprototypen, Review} & \shortstack{MS3-RV Ende Elaboration} \\
\hline
\textbf{SW09} & \shortstack{Review von Architektur/Design \\ und Architekturdokumenten} & \shortstack{MS4-RV Architektur/Design} \\
\hline
\textbf{28.05.15} & \shortstack{MS5-RV \\ Schlusspräsentation/-\\abgabe} & \shortstack{Präsentation und Demo \\ der Software} \\
\hline
\end{tabularx}
