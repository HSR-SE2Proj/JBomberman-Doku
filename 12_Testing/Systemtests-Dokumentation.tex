...
\subsection{UC01: JBomberman spielen}\subsubsection{Systemtests}\begin{tabularx}{\linewidth}{l X X}
  ...
  \bf{T13} & Bei Verbindungsunterbruch wird Spieler entfernt & Spieler wird 
  entfernt\\
  \bf{T14} & Wenn Spiel gestartet kann kein Spieler mehr sich auf den Server 
  verbinden & Verbinden nicht möglich \\
  \bf{T15} & PowerUps kommen zutage & PowerUp erscheinen \\
  \bf{T16} & PowerUp Funktion funktioniert & PowerUp funktioniert \\
\end{tabularx}
