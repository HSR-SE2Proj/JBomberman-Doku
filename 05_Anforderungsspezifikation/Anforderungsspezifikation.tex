...
\begin{table}[h]
	\begin{tabular}{ll}
		...
		\bfseries Standartablauf & \begin{minipage}{5in}
			\vskip 4pt
			\begin{enumerate}
			...
			\vskip 4pt
		\end{minipage}  \\\hline 
		\bfseries Alternativer Ablauf & \begin{minipage}{5in}
			\vskip 4pt
			\begin{enumerate}
				\setcounter{enumi}{1}
				\item 
			...
			\vskip 4pt
		\end{minipage}   \\\hline 
		\bfseries Spezielle Anforderungen & Spieler  \\\hline 
		\bfseries Technologie- und Datenvarianten & Spieler  \\\hline 
		\bfseries Auftrittshäufigkeit & Spieler  \\\hline 
		\bfseries Offene Fragen & Spieler  \\\hline  
	\end{tabular}
\end{table}
