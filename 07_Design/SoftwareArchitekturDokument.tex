...
JBomberman wird in zewi einzelne Applikationen unterteilt (Server und Client), dabei werden die Sprites auf dem Client gespeichert was diesen natürlich grösser macht ca.: 17 MB. Der Server selbst sollte nicht grösser als ca.: 3 MB werden.
