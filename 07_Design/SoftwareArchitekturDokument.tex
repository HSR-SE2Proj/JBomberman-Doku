...
Es besteht lediglich ein GUI für den Client, der Server soll über die CLI gestartet werden.
...
\includegraphics[scale=0.6]{Lobby}
 
\newpage


\section{Grössen und Leistung}
JBomberman wird in zewi einzelne Applikationen unterteilt (Server und Client), dabei werden die Sprites auf beiden Seiten benötigt dadurch erwarten wir eine Speicherverbrauch von ca.: 17MB.
Das Spiel kann auf allen Clients gespielt werden, welche Java installiert haben und eine Tastatur als Eingabegerät haben.
Es ist allerdings ein minimale Bildschirmauflösung von 832 x 832 nötig.
